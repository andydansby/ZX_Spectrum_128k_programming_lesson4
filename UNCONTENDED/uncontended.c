...
//powerful troubleshooting tool
        //intrinsic_label(label_start);
        //intrinsic_label(label_end);
...
void main ()
{
    ...
    //uncomment both labels and look at map to find address
    // then set breakpoints in your favorite emulator to see
